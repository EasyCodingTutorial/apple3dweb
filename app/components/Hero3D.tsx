  ...
  return (
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
        ...
        >
          <h1 className="text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300">
            Apple Vision Pro
          </h1>
        ...
        <div className="absolute inset-0 z-20">
          <DynamicCanvas shadows camera={{ position: [0, 0, 5], fov: 75 }}>
            <Scene />
          </DynamicCanvas>
        </div>
